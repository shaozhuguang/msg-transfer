package com.farmer.x.communication.callback;
...
public class CallBackBarrier {
     ...
     * @return
     */
    public static CallBackBarrier newCallBackBarrier(int barrierLength) {
     ...
     * @return
     */
    public static CallBackBarrier newCallBackBarrier(int barrierLength, long maxTryCallMillSeconds) {
